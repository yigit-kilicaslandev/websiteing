...
import { House, Library, X } from "lucide-react";
...
export const DATA = {
  ...
  photos: [
    { src: "https://upload.wikimedia.org/wikipedia/commons/0/02/Barcelona_March_2015-2b.jpg", alt: "Barcelona, Spain" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/a/a8/Tour_Eiffel_Wikimedia_Commons.jpg", alt: "Paris, France" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/1/19/London_Skyline.jpg", alt: "London, England" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/e/e6/Dubai_Marina_Skyline.jpg", alt: "Dubai, UAE" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/7/72/Parthenon-Acropolis_of_Athens-3.jpg", alt: "Athens, Greece" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/f/f6/Crete_Landscape_R03.jpg", alt: "Crete, Greece" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/9/96/Lighthouse_at_Alexandroupolis%2C_Greece.jpg", alt: "Alexandroupolis, Greece" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/5/53/Colosseum_in_Rome%2C_Italy_-_April_2007.jpg", alt: "Rome, Italy" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/1/17/Panorama_of_Canal_Grande_and_Ponte_di_Rialto%2C_Venice_-_September_2017.jpg", alt: "Venice, Italy" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/a/a0/Dome_of_Cattedrale_di_Santa_Maria_del_Fiore_%28Florence%29.jpg", alt: "Florence, Italy" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/2/27/1000_Three_domes_of_Oia_in_Santorini_Photo_by_Giles_Laurent.jpg", alt: "Santorini, Greece" },
  ],
  skills: [
